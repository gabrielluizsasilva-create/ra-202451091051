...
A maior dificuldade seria no momento de encontrar a vulnerabilidade de número 2 visto que o scanner vê uma consulta simples no banco pelo ID considerando o código correto, sem saber se o id deveria ou não pertencer aquele usuário.
